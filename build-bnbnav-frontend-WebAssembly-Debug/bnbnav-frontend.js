...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 4472624,
    DYNAMIC_BASE = 9715504,
    DYNAMICTOP_PTR = 4472448;
...
var wasmBinaryFile = 'bnbnav-frontend.wasm';
...
function prepareVoices(){ let voices = window.speechSynthesis.getVoices(); }
function say(text,lang){ text = UTF8ToString(text); lang = UTF8ToString(lang); let utterance = new SpeechSynthesisUtterance(text); utterance.lang = lang; let selectedVoice = null; for (let voice of window.speechSynthesis.getVoices()) { if (voice.lang.startsWith(lang.toLowerCase())) selectedVoice = voice; } if (selectedVoice) { utterance.voice = selectedVoice; window.speechSynthesis.speak(utterance); return true; } else { console.log("Language " + lang + " not supported"); return false; } }



// STATICTOP = STATIC_BASE + 4471600;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=4472608;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=4472464;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 4472512, 4), 4472512);
